    ...
    public partial class frmMain : Form
    {
        ...
        private void btnSignup_Click(object sender, EventArgs e)
        {
            using (var frm = new frmRegister())
            {
                ...
                {
                    // Đăng ký thành công, mở form đăng nhập
        ...
        private void btnSyncData_Click(object sender, EventArgs e)
        {
            ...
            // Làm mới lại dữ liệu khóa học sau khi đồng bộ
            if (pnlContent.Controls.Count > 0 && pnlContent.Controls[0] is UcCourses ucCourses)
            {
                ucCourses.RefreshData();
            }
            // Nếu đang ở trang chủ, refresh _homeCourses
            if (pnlContent.Controls.Contains(_homeCourses))
            {
                _homeCourses.RefreshData();
            }
        }
